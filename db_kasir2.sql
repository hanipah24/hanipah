...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2026 at 08:28 AM
...
(1, 'Genara', 'Jawa barat', '0827167266'),
(2, 'Kaidan', 'Jakarta', '0828292383');
...
(1, 'admin1', '$2y$10$AK0VlIzwoP84k8A.US68Xexztggx0XNwRtjcD5nXXcI/eHsyk2DKC', 'Administrator'),
(2, 'petugas1', '$2y$10$xbfcxa8Z.C3z3nRT.obrjuZTHsXHFkS4.XwQRReWpwjqBgno084NC', 'Petugas'),
(3, 'petugas2', '$2y$10$E3FBuGShg1N8lzbzLjVWb.heuXYIFamQXAqPXaCymBWPGKoHlNjuq', 'Petugas'),
(4, 'admin2', '$2y$10$bSNh3k5/S.kG8mc6nJgAGOpjd6W3lPYRxyUPuvOLWZjusx5UZolIy', 'Administrator');
...
(2, '2025-10-11', 287000.00, NULL, 2),
(3, '2025-10-13', 175000.00, NULL, 1),
(4, '2025-10-13', 287000.00, NULL, 1);
...
ALTER TABLE `penjualan`
  ...
  ADD CONSTRAINT `penjualan_ibfk_2` FOREIGN KEY (`UserID`) REFERENCES `pengguna` (`UserID`);
COMMIT;
